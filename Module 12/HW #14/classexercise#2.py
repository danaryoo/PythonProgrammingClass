...
class TestAvg:
    def __init__(self):
        ...
        self.result_label2 = tkinter.Label(self.sum_frame,text = 'Sum: ')
        ...
        self.sum_button = tkinter.Button(self.button_frame,text = 'Sum',command=self.calc_sum)
    ...
    def calc_sum(self):
        ...
        self.summation = (self.test1 + self.test2 + self.test3 + self.test4 + self.test5)
        self.sum.set(self.summation)
